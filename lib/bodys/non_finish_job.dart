...
import 'package:japea/states/detail.dart';
import 'package:japea/utility/my_calculate.dart';
...
class _NonfinishJobState extends State<NonFinishJob> {
  ...
  Future<void> readDataJob() async {
    ...
    String path =
        'https://www.androidthai.in.th/egat/getUserWhereIdOfficerJa.php?isAdd=true&idOfficer=$idOfficer';
